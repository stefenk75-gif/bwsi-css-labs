...
def main():
    ...
    name = "Stefen King" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("Hello, my name is Stefen King. I'm a junior at Pass Christian High school in southern Mississippi. I love robotics, football, and music.")
